  ...
  return (
    <div className="min-h-screen bg-devcraft-bg flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-sm text-devcraft-slate hover:text-devcraft-violet transition-colors mb-8"
         >
        ...
        >
          ...
          <div className="p-6 border-b border-devcraft-border">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h1 className="text-xl font-bold text-devcraft-foreground">Recover Download</h1>
                <p className="text-sm text-devcraft-slate">Lost your download link? We got you.</p>
              </div>
            </div>
          </div>
            ...
            <AnimatePresence mode="wait">
              {step === "input" && (
                ...
                >
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-devcraft-slate-light flex items-center gap-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-devcraft-surface border border-devcraft-border rounded-xl
                               text-devcraft-foreground placeholder-devcraft-slate focus:outline-none focus:border-devcraft-violet/50
                               focus:ring-1 focus:ring-devcraft-violet/20 transition-all"
                    />
                    <p className="text-xs text-devcraft-slate">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-6 py-4 rounded-xl
                             ...
                             hover:bg-devcraft-violet-glow hover:shadow-violet-glow
              ...
              {step === "searching" && (
                ...
                >
                  ...
                  <p className="text-devcraft-slate">Looking up your order...</p>
                </motion.div>
              )}
              ...
              {step === "found" && (
                ...
                >
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-devcraft-foreground">Download link sent!</h3>
                    <p className="text-sm text-devcraft-slate mt-2">
                      We found your order for <span className="text-devcraft-violet">{orderInfo?.templateTitle}</span>
                    </p>
                    <div className="flex items-center justify-center gap-2 mt-3 text-sm text-devcraft-slate">
                      <Clock className="w-4 h-4" />
                      <span>Link expires {orderInfo?.expiresAt}</span>
                    </div>
                  </div>
                  <p className="text-xs text-devcraft-slate">
                    Check your inbox at <span className="text-devcraft-slate-light">{email}</span>. If you don't see it, check your spam folder.
                  </p>
                  <button
                    onClick={() => {
                      setStep("input")
                    ...
                    className="px-6 py-3 rounded-xl bg-devcraft-surface border border-devcraft-border
                             text-devcraft-slate-light font-medium hover:text-devcraft-foreground hover:border-devcraft-border-hover
              ...
              {step === "notfound" && (
                <motion.div
                  ...
                  className="text-center py-8 space-y-6"
                >
                  <div className="w-16 h-16 rounded-full bg-devcraft-slate/10 flex items-center justify-center mx-auto">
                    <AlertCircle className="w-8 h-8 text-devcraft-slate" />
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-devcraft-foreground">No order found</h3>
                    <p className="text-sm text-devcraft-slate mt-2">
                      We couldn't find any completed orders for <span className="text-devcraft-slate-light">{email}</span>
                    </p>
                  </div>
                  <div className="space-y-2 text-xs text-devcraft-slate">
                  ...
                  <button
                    ...
                    className="px-6 py-3 rounded-xl bg-devcraft-violet text-devcraft-bg font-medium
                             hover:bg-devcraft-violet-glow transition-all duration-200"
                  >
                    Try Again
                  </button>
                </motion.div>
              ...
              {step === "error" && (
                ...
                >
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-devcraft-foreground">Something went wrong</h3>
        ...
        {/* Help text */}
        <p className="text-center text-xs text-devcraft-slate-dark mt-6">
