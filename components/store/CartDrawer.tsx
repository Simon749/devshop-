            ...
            >
              ...
              <div className="flex items-center justify-between px-6 h-16 border-b border-devcraft-border shrink-0">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="font-mono text-sm font-medium text-devcraft-foreground tracking-wide">
                    Your Cart
                  </h2>
              ...
              <div className="flex-1 overflow-y-auto px-6 py-4">
                {items.length === 0 ? (
                  <div className="flex flex-col items-center justify-center h-full text-center">
                    ...
                    <h3 className="text-devcraft-foreground font-medium mb-2">Your cart is empty</h3>
                    ...
                    <Link
                      href="/templates"
                      onClick={closeCart}
                      className="px-6 py-2.5 bg-devcraft-violet text-devcraft-bg text-xs font-mono
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between gap-2">
                            <div>
                              <h4 className="text-sm font-medium text-devcraft-foreground truncate">
                                {item.title}
                              </h4>
                            ...
                            <div className="flex items-center gap-1">
                              <button
                                ...
                                className="w-7 h-7 rounded-md bg-devcraft-card border border-devcraft-border
                                           ...
                                           hover:text-devcraft-foreground transition-colors"
                              >
                                <Minus className="w-3 h-3" />
                              </button>
                              <span className="w-8 text-center text-sm text-devcraft-foreground font-mono">
                                {item.quantity}
                              </span>
                              <button
                                onClick={() => updateQuantity(item.id, item.quantity + 1)}
                ...
                <div className="border-t border-devcraft-border p-6 space-y-4 shrink-0">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="pt-2 border-t border-devcraft-border flex justify-between">
                      <span className="text-sm font-medium text-devcraft-foreground">Total</span>
                      <span className="text-lg font-bold text-devcraft-foreground font-mono">
                    ...
                    {items.length === 1 ? (
                      ...
                      <button
                        ...
                        className="w-full flex items-center justify-center gap-2 px-6 py-3.5
                                   bg-devcraft-violet text-devcraft-bg font-semibold rounded-xl
                                  hover:bg-devcraft-violet-glow hover:shadow-violet-glow transition-all
                                   active:scale-[0.98]"
                      >
